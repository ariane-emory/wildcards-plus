...
// =================================================================================================
let inspect_fun = (thing, depth = 2) => util.inspect(thing, null, depth);
  ...
  // ===============================================================================================
{
  ...
  // -------------------------------------------------------------------------------------------------
  inspect_fun = (thing, depth = 2) => JSON.stringify(thing, null, depth);
                         ...
                         if (thing instanceof ASTUpdateConfigUnary) { // ASTUpdateConfigUnary
                           ...
                           if (log_config_enabled)
                             console.log(`config ${thing.assign ? '=' : '+='} ` +
                                         `${inspect_fun(new_obj)}, ` +
                                         `config is now: ` +
                                         `${inspect_fun(context.config, null)}`);
                         }
...
// =================================================================================================
// log_match_enabled = true;
// jconsole.log(inspect_fun({ foo: 123, bar: 234 }));
