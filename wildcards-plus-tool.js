...
// Content from @specopx's 'Prompt Bucket': Cinematic terms
@pb_cinematicTerms :=  {
...
// Content from @specopx's 'Prompt Bucket': 3D rendering terms
@pb_renderingTerms := {
...
// Content from @specopx's 'Prompt Bucket': Rembrandt lighting and artistic terms
@pb_lightingTerms := {
...
// Content from @specopx's 'Prompt Bucket': Subjects/scenes
@pb_subjects := {
...
// Content from @specopx's 'Prompt Bucket': Characters/entities
@pb_characters := {
...
// Content from @specopx's 'Prompt Bucket': Moods/atmospheres
@pb_moods := {
...
// Content from @specopx's 'Prompt Bucket': Time periods
@pb_timePeriods := {
...
// Content from @specopx's 'Prompt Bucket': Color palettes
@pb_colorPalettes := {
...
// Content from @specopx's 'Prompt Bucket': Artistic styles
@pb_artisticStyles := {
...
// Content from @specopx's 'Prompt Bucket': Video game graphics terms
@pb_gameGraphicsTerms := {
...
// Content from @specopx's 'Prompt Bucket': Camera settings
@pb_cameraSettings := {
...
// Content from @specopx's 'Prompt Bucket': Film directors for style references
@pb_directors := {
...
// Content from @specopx's 'Prompt Bucket': Technical details to add verisimilitude
@pb_technicalDetails := {
